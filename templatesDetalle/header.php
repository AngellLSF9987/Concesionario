        ...
        <div class="row">
          ...
          <div class="col-sm-4 offset-md-1 py-4">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="index.php" class="text-white">Regresar a la página principal</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          <h1 class="h1" style="margin:10px 0%; flex-direction:row;font-size: 3em ">Concesionario</h1>
          <hr>
          <p class="p" style="margin:10px;">Crearemos uno de los carritos virtuales de mayor calidad de entre todos los conocidos en el mundo
